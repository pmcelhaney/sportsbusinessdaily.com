...
ADMINS = (
     ('Patrick McElhaney', 'pmcelhaney@bizjournals.com'),
)
...
DATABASE_NAME = 'sbd_django'            # Or path to database file if using sqlite3.
...
SECRET_KEY = 'p7!@1p0uchhbd&zrudwqf+htso75mvh))s7ll7-#asyz7l2%*b'
